# projeto_01_heroi_blueEdtech (CONTEÚDO USADO NO PROJETO: VARIÁVEIS, OPERADORES MATEMÁTICOS, BOOLEANOS, CONDICIONAS E DO WHILE)
Projeto 1 Blue Edtech JavaScript

Projeto 1 - A Jornada do Herói

Hoje nós começamos o nosso primeiro projeto entregável! Esse projeto vai avaliar os conteúdos passados durante essa primeira semana, e se você consegue desenvolver uma programação utilizando todos eles. (CONTEÚDOS PASSADOS NA PRIMEIRA SEMANA: VARIÁVEIS, OPERADORES MATEMÁTICOS, BOOLEANOS, CONDICIONAS E DO WHILE)
